    ...
    <div className="mx-4 mb-3">
      <div className="rounded-3xl overflow-hidden border border-amber-200 shadow-sm">
        ...
        <div className="px-4 py-3 flex items-center gap-2"
          ...
          <div>
            <div className="font-bold text-[16px] text-amber-800">Split date has passed</div>
            <div className="text-[16px] text-amber-600">{date}</div>
          </div>
        </div>
        ...
        <div className="bg-white px-4 py-4">
          ...
          <div className="bg-gray-50 rounded-2xl p-3 mb-4 flex items-center gap-3">
            ...
            <div>
              <div className="font-semibold text-[16px] text-gray-900">{split.title}</div>
          ...
          {saving ? (
            ...
            <div className="grid grid-cols-2 gap-2">
              <button onClick={() => confirm(true)}
                className="py-3 rounded-2xl text-[16px] font-bold text-white flex items-center justify-center gap-2"
                style={{ background: G, boxShadow: '0 4px 12px rgba(15,122,75,.3)' }}>
                ✓ Yes, it happened!
              </button>
              <button onClick={() => confirm(false)}
                className="py-3 rounded-2xl text-[16px] font-bold bg-gray-100 text-gray-600 flex items-center justify-center gap-2">
                ✗ No, it didn't
              </button>
            </div>
          )}
