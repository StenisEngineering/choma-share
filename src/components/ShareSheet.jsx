    ...
    <>
      ...
      <div className={`fixed bottom-0 left-0 right-0 bg-white rounded-t-3xl z-50 p-5 border-t border-gray-100 transition-transform ${open ? 'translate-y-0' : 'translate-y-full'}`}>
        ...
        <div className="flex items-start justify-between mb-4">
          <div>
            <h3 className="font-display font-bold text-[19px] text-gray-900">Share to WhatsApp</h3>
            <p className="text-[13px] text-gray-400 mt-0.5">Drop this into your community groups</p>
          </div>
        ...
        <a href={waUrl} target="_blank" rel="noreferrer" onClick={onClose}
          className="flex items-center justify-center gap-2.5 w-full bg-[#25D366] text-white rounded-2xl py-4 text-[15px] font-bold active:scale-98 transition-transform">
        ...
        <button onClick={onClose} className="w-full mt-2.5 py-3 text-[14px] font-semibold text-gray-400">Cancel</button>
      </div>
    </>
  )
}
