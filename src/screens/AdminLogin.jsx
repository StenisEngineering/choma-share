      ...
      <div className="w-full max-w-sm bg-white rounded-3xl shadow-xl overflow-hidden">
        ...
        <form onSubmit={handleLogin} className="px-6 py-6 space-y-3">
          ...
          <button
            ...
            className="w-full text-white rounded-2xl py-4 text-[15px] font-bold flex items-center justify-center gap-2 disabled:opacity-40 transition-opacity"
        ...
        <p className="text-center text-[12px] text-gray-400 pb-5">
